...
func (tr *Route) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Destinations"))
	opts = append(opts, resource.WithNameFilter("Service"))
	opts = append(opts, resource.WithNameFilter("Sources"))
