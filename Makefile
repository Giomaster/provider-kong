...
PROJECT_NAME ?= provider-kong
PROJECT_REPO ?= github.com/Giomaster/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= Kong/kong-gateway
export TERRAFORM_PROVIDER_REPO ?= https://github.com/Kong/terraform-provider-kong-gateway
export TERRAFORM_PROVIDER_VERSION ?= 0.5.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-kong-gateway
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-kong-gateway_v0.5.2
...
xpkg.build.provider-kong: do.build.images
